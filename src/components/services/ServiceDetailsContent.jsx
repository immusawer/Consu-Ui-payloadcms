                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="item">
                                                ...
                                                <h4><Link to="#" onClick={handleSmoothScroll}>Investment Planning</Link></h4>
                                                <p>
                                        ...
                                        <div className="col-md-6">
                                            <div className="item">
                                                ...
                                                <h4><Link to="#" onClick={handleSmoothScroll}>Markets Research</Link></h4>
                                                <p>
                                                    These cases are perfectly simple and easy to distinguish. In a free hour, when our power.
                                                </p>
                                            </div>
                                ...
                                <div className="single-widget services-list-widget">
                                    ...
                                    <div className="content">
                                        <ul>
                                            ...
                                            <li className="current-item"><Link to="#">Growth Hacking</Link></li>
                                            <li><Link to="#">Lead Generation</Link></li>
                                            <li><Link to="#">Offline SEO</Link></li>
